...
export function getBostonJourneyEquivalence(distanceKm) {
  ...
  return {
    // The origin is half the sentence: "98% of the way to Halifax" is
    // meaningless without it. Returned rather than hardcoded at the call site
    // so the copy stays truthful if BOSTON ever changes.
    origin: BOSTON.name,
