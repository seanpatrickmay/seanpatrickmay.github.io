...
// being trained — the training block is marathon prep, not triathlon. Everything
// else (walks, strength, rowing, a stray swim)
...
/**
 * Returns `{ rows, totalHours }`, or null when there is no data.
 *
...
export function getTrainingSplit(statsData) {
  ...
  return { rows, totalHours: combined.hours };
}
