            ...
            <div className="flex flex-wrap gap-2">
              {selected.map(value => (
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-1 text-xs font-medium text-slate-600 transition hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-slate-400 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
                >
                  {value}
